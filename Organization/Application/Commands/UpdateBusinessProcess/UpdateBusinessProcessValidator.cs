...
public sealed class UpdateBusinessProcessValidator : AbstractValidator<UpdateBusinessProcessCommand>
{
    public UpdateBusinessProcessValidator(OrganizationDbContext db, ITenantContext tenantContext)
    {
        RuleFor(x => x.Id)
